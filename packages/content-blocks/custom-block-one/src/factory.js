...
import { IconAlignLeft, IconAlignCenter, IconStar } from '@codexteam/icons';
 ...
 */
export default class CustomBlockOneFactory {
  /**
  ...
  static get DEFAULT_ALIGNMENT() {
    return CustomBlockOneFactory.ALIGNMENTS.left;
  }
  ...
  constructor({ data, config, api, readOnly }) {
    const { ALIGNMENTS, DEFAULT_ALIGNMENT } = CustomBlockOneFactory;
    ...
    this.quotePlaceholder =
      ...
      CustomBlockOneFactory.DEFAULT_QUOTE_PLACEHOLDER;
    this.captionPlaceholder =
      config.captionPlaceholder ||
      CustomBlockOneFactory.DEFAULT_CAPTION_PLACEHOLDER;

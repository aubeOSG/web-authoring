...
COPY ./packages/content-blocks/custom-inline-tools/package.json ./packages/content-blocks/custom-inline-tools/package.json
...
COPY ./packages/content-blocks/custom-inline-tools ./packages/content-blocks/custom-inline-tools
